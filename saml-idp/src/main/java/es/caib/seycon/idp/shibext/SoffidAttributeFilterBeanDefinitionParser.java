 ...
 */
public class SoffidAttributeFilterBeanDefinitionParser extends AbstractReloadableServiceBeanDefinitionParser {

    /** Schema type. */
    public static final QName SCHEMA_TYPE = new QName(NamespaceHandler.NAMESPACE,
            "SoffidAttributeFilter");

    /** {@inheritDoc} */
    protected Class getBeanClass(Element arg0) {
        return SoffidAttributeFilter.class;
    }
}