    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (p1 == null || p1.length() == 0) {
        	...
        	try {
                ...
                error = Messages.getString("PasswordChangeRequiredAction.password.not.suitable"); //$NON-NLS-1$
            } catch (Exception e) {
                error = Messages.getString("PasswordChangeRequiredAction.internal.error")+e.getMessage();//$NON-NLS-1$
