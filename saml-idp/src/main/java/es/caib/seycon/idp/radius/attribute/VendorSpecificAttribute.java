 ...
 */
package com.soffid.iam.sync.idp.radius.attribute;
...
import com.soffid.iam.sync.idp.radius.dictionary.AttributeType;
import com.soffid.iam.sync.idp.radius.dictionary.Dictionary;
...
public class VendorSpecificAttribute extends RadiusAttribute {
	 ...
	 * @see com.soffid.iam.sync.idp.radius.attribute.RadiusAttribute#setDictionary(com.soffid.iam.sync.idp.radius.dictionary.Dictionary)
	 */
	 ...
	 * @see com.soffid.iam.sync.idp.radius.attribute.RadiusAttribute#writeAttribute()
	 */
	 ...
	 * structure.
	 * @see com.soffid.iam.sync.idp.radius.attribute.RadiusAttribute#readAttribute(byte[], int,
	 * int)
	 */
	 ...
	 * @see com.soffid.iam.sync.idp.radius.attribute.RadiusAttribute#toString()
	 */
