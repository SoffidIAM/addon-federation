...
public class DefinitionParser extends BaseDataConnectorBeanDefinitionParser {
    public static final QName SCHEMA_NAME = new QName(NamespaceHandler.NAMESPACE, "SeuLookup"); //$NON-NLS-1$
    ...
    protected Class getBeanClass(Element element) {
        return DataConnectorFactory.class;
    }
}
