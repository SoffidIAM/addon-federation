 ...
 */
package com.soffid.iam.addons.federation.idp.radius.attribute;
...
public class VendorSpecificAttribute extends RadiusAttribute {
	 ...
	 * @see com.soffid.iam.addons.federation.idp.radius.attribute.RadiusAttribute#setDictionary(com.soffid.iam.addons.federation.idp.radius.dictionary.Dictionary)
	 */
	 ...
	 * @see com.soffid.iam.addons.federation.idp.radius.attribute.RadiusAttribute#writeAttribute()
	 */
	 ...
	 * structure.
	 * @see com.soffid.iam.addons.federation.idp.radius.attribute.RadiusAttribute#readAttribute(byte[], int,
	 * int)
	 */
	 ...
	 * @see com.soffid.iam.addons.federation.idp.radius.attribute.RadiusAttribute#toString()
	 */
