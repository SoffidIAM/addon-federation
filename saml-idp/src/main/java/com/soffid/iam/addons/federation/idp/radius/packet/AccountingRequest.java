...
public class AccountingRequest extends RadiusPacket {
	 ...
	 * @see com.soffid.iam.addons.federation.idp.radius.packet.RadiusPacket#updateRequestAuthenticator(java.lang.String, int, byte[])
	 */
	 ...
	 */
	@Override
	public void checkRequestAuthenticator(String sharedSecret) throws RadiusException {
		byte[] expectedAuthenticator = updateRequestAuthenticator(sharedSecret, pktLength, attributeData);
