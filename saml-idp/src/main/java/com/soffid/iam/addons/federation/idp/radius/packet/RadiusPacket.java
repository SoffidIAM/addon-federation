 ...
 */
package com.soffid.iam.addons.federation.idp.radius.packet;
...
import com.soffid.iam.addons.federation.idp.radius.dictionary.AttributeType;
import com.soffid.iam.addons.federation.idp.radius.dictionary.DefaultDictionary;
import com.soffid.iam.addons.federation.idp.radius.dictionary.Dictionary;
...
public class RadiusPacket {
	 ...
	 */
	public static RadiusPacket decodeRequestPacket(InputStream in) 
	throws IOException, RadiusException {
		return decodePacket(DefaultDictionary.getDefaultDictionary(), in, null, null);
	}
	 ...
	 * @exception RadiusException malformed packet
	 */
	public static RadiusPacket decodeRequestPacket(Dictionary dictionary, InputStream in) 
	throws IOException, RadiusException {
		return decodePacket(dictionary, in, null, null);
	}
	...
	throws IOException, RadiusException {
		...
		rp.pktLength = length;
		rp.attributeData  = attributeData;
	 ...
	 */
	public void checkRequestAuthenticator(String sharedSecret)
	 ...
	 * @param sharedSecret
	 */
	public void decodeRequestAttributes(String sharedSecret) 
	throws RadiusException {
	}
