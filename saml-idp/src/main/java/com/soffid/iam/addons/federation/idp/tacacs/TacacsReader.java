package com.soffid.iam.addons.federation.idp.tacacs;
...
public class TacacsReader extends Thread
{
	...
	private FederationMember serviceProvider;

	
	protected TacacsReader(Socket socket, String key, FederationMember sp) throws IOException
	{
		super("TACACS+");
		setDaemon(true);
	...
	public FederationMember getServiceProvider() {
