 ...
 */
package com.soffid.iam.addons.federation.idp.radius.dictionary;
 ...
 * @see com.soffid.iam.sync.idp.radius.dictionary.Dictionary
 * @see com.soffid.iam.sync.idp.radius.dictionary.WritableDictionary
 */
...
implements WritableDictionary {
	 ...
	 * @see com.soffid.iam.sync.idp.radius.dictionary.Dictionary#getAttributeTypeByCode(int)
	 */
	 ...
	 * @param typeCode attribute type code
	 * @return AttributeType or null
	 * @see com.soffid.iam.sync.idp.radius.dictionary.Dictionary#getAttributeTypeByCode(int, int)
	 */
	 ...
	 * @return AttributeType or null
	 * @see com.soffid.iam.sync.idp.radius.dictionary.Dictionary#getAttributeTypeByName(java.lang.String)
	 */
	 ...
	 * @see com.soffid.iam.sync.idp.radius.dictionary.Dictionary#getVendorId(java.lang.String)
	 */
	 ...
	 * @see com.soffid.iam.sync.idp.radius.dictionary.Dictionary#getVendorName(int)
	 */
