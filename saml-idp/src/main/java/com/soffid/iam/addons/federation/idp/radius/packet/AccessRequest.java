...
public class AccessRequest extends RadiusPacket {
	 ...
	 * @see com.soffid.iam.addons.federation.idp.radius.packet.RadiusPacket#decodeRequestAttributes(java.lang.String)
	 */
	@Override
	...
	throws RadiusException {
		...
		RadiusAttribute authenticator = getAttribute(MESSAGE_AUTHENTICATOR); // Message authenticator
	 ...
	 * @see com.soffid.iam.addons.federation.idp.radius.packet.RadiusPacket#encodeRequestAttributes(java.lang.String)
	 */
